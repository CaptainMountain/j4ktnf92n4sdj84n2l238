        ...
        <div class="Right">
            <nav>
                <ul>
                    ...
                    <li><a href="samorezu.php" class="Active">Саморезы</a></li>
                </ul>
            </nav>
        </div>
    </div>
            ...
            <div id="CatalogPage" class="ProductsPage">
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/krepejnaya-plastina.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/s1.jpg" alt="product43">
                ...
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/plastina-soedinitelnaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/s2.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Саморезы черные по металлу</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/gvozdevaya-plastina.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/s3.jpg" alt="product3">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Саморезы с прессшайбой, цинк, наконечник-острый</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/plastina-soedinitelnaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/s4.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                ...
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/plastina-soedinitelnaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/s5.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Саморезы желтые по дереву</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/plastina-soedinitelnaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/s6.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Саморезы желтые универсальные</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/plastina-soedinitelnaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/s7.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Саморезы кровельные, цинк</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/plastina-soedinitelnaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/s8.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Саморезы оконные, желтые</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
