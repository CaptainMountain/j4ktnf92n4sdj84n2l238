        ...
        <div class="Right">
            <nav>
                <ul>
                    ...
                    <li><a href="ankeru.php" class="Active">Анкеры</a></li>
        ...
        <div class="Products Catalog">
            ...
            <div id="CatalogPage" class="ProductsPage">
                <article class="Product">
                    <a class="Product__Link" href="detail-ankeru/anker-regul-po-vusote.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/a1.jpg" alt="product43">
