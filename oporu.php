        ...
        <div class="Right">
            <nav>
                <ul>
                    ...
                    <li><a href="oporu.php" class="Active">Опоры</a></li>
                </ul>
            </nav>
        </div>
    </div>
        ...
        <div class="Products Catalog">
            ...
            <div id="CatalogPage" class="ProductsPage">
                <article class="Product">
                    <a class="Product__Link" href="detail-oporu/skolzyashyaya-opora.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/o1.jpg" alt="product43">
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Скользящая опора</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-oporu/opora-brusa.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/o2.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Опора бруса</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-oporu/opora-brusa-zakrutaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/o3.jpg" alt="product3">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Опора бруса закрытая</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-oporu/opora-balki.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/o4.jpg" alt="product45">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Опора балки</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-oporu/derjatel-balki.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/o5.jpg" alt="product46">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Держатель балки</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-oporu/skolzashaya-opora-dlya-stropil.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/o6.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Скользящая опора для стропил</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-oporu/skolzashaya-opora-dlya-stropil-zakrutaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/o7.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Скользящая опора для стропил закрытая</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-oporu/zakladnaya-opora.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/o8.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Закладная опора</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-oporu/osnovanie-kolonnu.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/o9.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Основание колонны</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
