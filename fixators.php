        ...
        <div class="Right">
            <nav>
                <ul>
                   ...
                   <li><a href="fixators.php" class="Active">Фиксаторы</a></li>
            ...
            <div id="CatalogPage" class="ProductsPage">
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/krepejnaya-plastina.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/f1.jpg" alt="product43">
                ...
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/plastina-soedinitelnaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/f2.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                ...
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/gvozdevaya-plastina.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/f3.jpg" alt="product3">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                ...
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/plastina-soedinitelnaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/f4.jpeg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Подставка-опора на сыпучие поверхности, для кубика 35-50</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/plastina-soedinitelnaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/f5.jpeg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                ...
                <article class="Product">
                    <a class="Product__Link" href="detail-plastinu/plastina-soedinitelnaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/f6.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
