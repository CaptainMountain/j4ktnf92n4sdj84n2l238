...
<head>
    <meta charset="UTF-8">
    <title>Саморезы черные по дереву</title>
...
<nav class="Menu Container">
    <ul>
         <li><a href="../ugolki.html" style="text-decoration: underline;">Уголки</a>
        ...
        <li><a href="../oporu.html" style="text-decoration: underline;">Опоры</a>
            <div class="Square10"></div>
            <div class="DropDownMenu Row Swing-in-top-fwd">
                <div class="Column">
                    <h4>Опоры:</h4>
        ...
        <li><a href="../plastinu.html" style="text-decoration: underline;">Пластины</a>
            <div class="Square10"></div>
            <div class="DropDownMenu Row Swing-in-top-fwd">
                <div class="Column">
                    <h4>Пластины:</h4>
        ...
        <li><a href="../lentu.html" style="text-decoration: underline;">Ленты</a>
            <div class="Square10"></div>
            <div class="DropDownMenu Row Swing-in-top-fwd">
                <div class="Column">
                    <h4>Ленты:</h4>
        ...
        <li><a href="../ankeru.html" style="text-decoration: underline;">Анкеры</a>
            <div class="Square10"></div>
            <div class="DropDownMenu Row Swing-in-top-fwd">
                <div class="Column">
                    <h4>Анкеры:</h4>
        ...
        <li><a href="../krepeju.html" style="text-decoration: underline;">Крепежи</a>
            <div class="Square10"></div>
            <div class="DropDownMenu Row Swing-in-top-fwd">
                <div class="Column">
                    <h4>Крепежи:</h4>
        ...
        <li><a href="krepeju.html">Фиксаторы</a>
            <div class="Square10"></div>
            <div class="DropDownMenu Row Swing-in-top-fwd">
                <div class="Column">
                    <h4>Фиксаторы:</h4>
        ...
        <li><a href="oporu.html">Саморезы</a>
            <div class="Square10"></div>
            <div class="DropDownMenu Row Swing-in-top-fwd">
                <div class="Column">
                    <h4>Саморезы:</h4>
...
<div class="BreadCrumbs">
    <div class="Container">
        <div class="Left">
            <h2>Саморезы черные по дереву</h2>
        </div>
        <div class="Right">
            <nav>
                <ul>
                    ...
                    <li><a href="#" class="Active">Мебельные уголки</a></li>
                </ul>
            </nav>
        </div>
    </div>
            ...
            <div class="Details">
                ...
                <nav class="Swing-in-top-fwd2">
                    <ul>
                        ...
                        <li><a href="../lentu.html">Ленты</a></li>
                        <li><a href="../ankeru.html">Анкеры</a></li>
                        <li><a href="../krepeju.html">Крепежи</a></li>
                         <li><a href="krepeju.html">Фиксаторы</a></li>
                        <li><a href="krepeju.html">Саморезы</a></li>
            ...
            <div id="CatalogPage" class="ProductsPage">
                <article class="Product">
                    <a class="Product__Link">
                        <div class="imgwow1">
                            <img class="Productwow" width: inherit; height: 280px; src="../img/details/s1.jpg" alt="product43">
                            
                        </div>
                        <div class="Product__Info">
                            <h2 class="Product__Name">Саморезы черные по дереву</h2>
