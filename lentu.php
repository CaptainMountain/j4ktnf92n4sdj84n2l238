        ...
        <div class="Right">
            <nav>
                <ul>
                    ...
                    <li><a href="lentu.php" class="Active">Ленты</a></li>
                </ul>
            </nav>
        </div>
    </div>
        ...
        <div class="Products Catalog">
            ...
            <div id="CatalogPage" class="ProductsPage">
                <article class="Product">
                    <a class="Product__Link" href="detail-lentu/lenta-montajnaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/l1.jpg" alt="product43">
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Лента монтажная</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-lentu/lenta-montajnaya-14-mm.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/l2.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Лента монтажная <br> (&Oslash отв. 14мм.)</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-lentu/lenta-dlya-ventilyacii_pryamaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/l3.jpg" alt="product3">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Лента для вентиляции, прямая</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-lentu/lenta-dlya-ventilyacii_volnoobraznaya.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/l4.jpg" alt="product45">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Лента для вентиляции волнообразная</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-lentu/perforirovannaya-lenta-dlya-teplogo-pola.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/l5.jpg" alt="product46">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Перфорированная лента для тёплого пола</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-lentu/tarnaya-lenta.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/l6.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Тарная лента</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
