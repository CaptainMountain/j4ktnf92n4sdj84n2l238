        ...
        <div class="Right">
            <nav>
                <ul>
                    ...
                    <li><a href="ugolki.php" class="Active">Уголки</a></li>
                </ul>
            </nav>
        </div>
    </div>
        ...
        <div class="Products Catalog">
            ...
            <div id="CatalogPage" class="ProductsPage">
                <article class="Product">
                    <a class="Product__Link" href="detail-ugolki/mebelnie-ugolki.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/u1.jpg" alt="product43">
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Мебельные уголки</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-ugolki/krepejnij-ugolok.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/u2.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёжный уголок</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-ugolki/krepejnij-usilennij-ugolok.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/u3.jpg" alt="product3">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёжный усиленный уголок</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-ugolki/krepejnij-ugolok-ravnostoronnij.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/u4.jpg" alt="product45">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёжный уголок равносторонний</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-ugolki/krepejnij-ugolok-s-2-usileniem.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/u5.jpeg" alt="product46">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёжный уголок с двойным усилением</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-ugolki/krepejnij-ugolok-assimetrichnij.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/u6.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёжный уголок ассиметричный</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-ugolki/krepejnij-ugolok-pod-135-gradusov.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/u7.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёжный уголок под 135°</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-ugolki/krepejnij-ugolok-z-obraznij.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/u8.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёжный уголок Z-образный</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-ugolki/krepejnij-ugolok-ankernij.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/u9.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёжный анкерный уголок</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-ugolki/krepejnij-ugolok-ravnostoronnij-shirokij.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/u10.png" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёжный уголок равносторонний, широкий</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-ugolki/uglovoi-soedinitel.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/u11.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Угловой соединитель</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
