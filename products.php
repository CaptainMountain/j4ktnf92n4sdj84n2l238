        ...
        <div class="Right">
            <nav>
                <ul>
                    ...
                    <li><a href="products.php" class="Active">Наши товары</a></li>
                </ul>
            </nav>
        </div>
    </div>
            ...
            <div id="CatalogPage" class="ProductsPage">
                ...
                <article class="Product">
                    <a class="Product__Link" href="oporu.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/o4.jpg" alt="product44">
                           <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                ...
                <article class="Product">
                    <a class="Product__Link" href="lentu.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/l1.jpg" alt="product45">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                ...
                <article class="Product">
                    <a class="Product__Link" href="ankeru.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/a1.jpg" alt="product46">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                ...
                <article class="Product">
                    <a class="Product__Link" href="krepeju.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k5.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
