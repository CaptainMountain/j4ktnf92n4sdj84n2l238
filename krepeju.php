        ...
        <div class="Right">
            <nav>
                <ul>
                    ...
                    <li><a href="krepeju.php" class="Active">Крепежи</a></li>
        ...
        <div class="Products Catalog">
            ...
            <div id="CatalogPage" class="ProductsPage">
                <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/podveski-mebelnie-cunk.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k13.jpg" alt="product44">
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Подвески мебельные, цинк</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/krepej-dlya-stoek.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k1.jpg" alt="product43">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёж для стоек</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/okonnue-plastinu.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k2.jpg" alt="product44">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Оконные пластины</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/podves-pryamoi.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k3.jpg" alt="product3">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Подвес прямой</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/krab.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k4.jpg" alt="product45">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Краб</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/shaiba-s-muftoi.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k5.jpg" alt="product46">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Шайба с муфтой</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
                </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/skoba-dlya-vagonki.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k6.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Скоба для вагонки (клеймер)</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/krepej-dlya-blokhausa.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k7.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёж для блокхауса</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/prujinnij-uzel.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k8.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Пружинный узел</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/krepej-dlya-terrasnoi-doski.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k9.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёж для террасной доски</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/krepej-dlya-stenovih-panelei-planfix.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k10.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёж для стеновых панелей "Планфикс"</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/krepej-dlya-terrasnoi-doski-TWIN.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k11.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепёж для террасной доски "TWIN"</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
                  ...
                  <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/kreplenie-stenovoe.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k12.JPG" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крепление стеновое</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/kruchok-vetrovoi.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k30.jpeg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Крючок ветровой</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/petlya-nakladnaya-cunk.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k31.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Петля накладная, цинк</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/petlya-strela.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k36.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Петля стрела</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
                 <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/podveski-mebelnie-cunk.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k13.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                ...
                <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/polkoderjatel.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k38.png" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Полкодержатель</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/proboi-ushko-cunk.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k18.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Пробой ушко, цинк</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
                <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/ruchka-skoba.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k26.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Ручка скоба</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
               <article class="Product">
                    <a class="Product__Link" href="detail-krepeji/zadvizhka-cunk.php">
                        <div class="Product__Photo">
                            <img class="Product__Image" src="img/details/k22.jpg" alt="product47">
                            <div class="Product__AddBtn">
                                <svg class="BasketSvgWhite" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 32 29" style="enable-background:new 0 0 32 29;" xml:space="preserve" width="32" height="29">
                        <g>
                        ...
                        <div class="Product__Info">
                            <h2 class="Product__Name">Задвижка, цинк</h2>
                            <span class="Product__Price Color_pink">есть в наличии</span>
                        </div>
                    </a>
               </article>
