...
<head>
    <meta charset="UTF-8">
    <title>Фиксатор арматуры "стульчик"</title>
...
<div class="BreadCrumbs">
    <div class="Container">
        <div class="Left">
            <h2>Фиксатор арматуры "стульчик"</h2>
        </div>
        <div class="Right">
            <nav>
                <ul>
            ...
            <div id="CatalogPage" class="ProductsPage">
                <article class="Product">
                    <a class="Product__Link">
                        <div class="imgwow1">
                            <img class="Productwow" width: inherit; height: 280px; src="../img/details/f2.jpg" alt="product43">
                            
                        </div>
                        <div class="Product__Info">
                            <h2 class="Product__Name">Фиксатор арматуры "стульчик"</h2>
