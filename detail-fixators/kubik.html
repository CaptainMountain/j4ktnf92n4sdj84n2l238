...
<head>
    <meta charset="UTF-8">
    <title>Фиксатор арматуры "кубик"</title>
            ...
            <div id="CatalogPage" class="ProductsPage">
                <article class="Product">
                    <a class="Product__Link">
                        <div class="imgwow1">
                            <img class="Productwow" width: inherit; height: 280px; src="../img/details/f3.jpg" alt="product43">
                            
                        </div>
                        <div class="Product__Info">
                            <h2 class="Product__Name">Фиксатор арматуры "кубик"</h2>
